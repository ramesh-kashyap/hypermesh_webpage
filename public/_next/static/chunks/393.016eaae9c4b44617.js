              ...
              n.useEffect(
                function () {
                  if (R.current) {
                    ...
                    Array.isArray(m) &&
                      m.length &&
                      ((R.current.currentRawFrame < m[0] ||
                        R.current.currentRawFrame > m[1]) &&
                        (R.current.currentRawFrame = m[0]),
                      R.current.setSegment(m[0], m[1]));
                  }
                },
                [m]
              ),
              n.useEffect(
                function () {
                  var e = [
                    ...
                    { name: "data_ready", handler: S },
                    { name: "data_failed", handler: h },
                    { name: "loaded_images", handler: O },
                    { name: "DOMLoaded", handler: A },
                    { name: "destroy", handler: w },
                  ].filter(function (e) {
